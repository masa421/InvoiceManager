                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" name="email" type="text" placeholder="" value="{{ $customers->email }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputLastName">Company</label>
                                        <input class="form-control py-4" name="company" type="text" placeholder="" value="{{ $customers->company }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" name="address" type="text" placeholder="" value="{{ $customers->address }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" name="phone" type="text" placeholder="" value="{{ $customers->phone }}" />
                                    </div>
                                </div>
                            </div>
